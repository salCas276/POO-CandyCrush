...
//Clase diseñada para el diseño de niveles nuevos
//NO corresponde hacer esto en Grid pues el diseño de niveles no es tarea de esa clase
public abstract class GenericLevel extends Grid {
    ...
    protected Cell getLevelWallCell() {
    ...
    protected void fillCells() {
        ...
        CandyGeneratorCell candyGenCell = getLevelGeneratorCell();
        Cell wallCell = getLevelWallCell();
